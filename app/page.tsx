        ...
        faq={[
          {
            ...
            svar: "Vi har base i Middelfart og dækker hele trekantsområdet og Fyn, herunder Fredericia, Kolding, Vejle og Odense — døgnet rundt.",
          },
          {
