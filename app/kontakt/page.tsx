    ...
    <>
      ...
      <SeoSektion
        ...
        afsnit={[
          ...
          "Vi dækker hele trekantsområdet og Fyn med base i Middelfart, herunder Fredericia, Kolding, Vejle og Odense — døgnet rundt. Har du et akut behov, rykker vi hurtigt ud. Kontakt os for en uforpligtende snak om din vagtopgave, så finder vi den rigtige løsning og pris sammen.",
        ]}
        faq={[
          {
          ...
          },
          {
            ...
            svar:
              "Vi har base i Middelfart og dækker hele trekantsområdet og Fyn — herunder Fredericia, Kolding, Vejle og Odense — døgnet rundt.",
          },
        ]}
      />
    </>
